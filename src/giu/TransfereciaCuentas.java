...
public class TransfereciaCuentas extends javax.swing.JInternalFrame {

    /**
     * Creates new form TransfereciaCuentas
     */
    public TransfereciaCuentas() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Transferencia entr Cuentas");
        ...
        Select1.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        Select1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccionar", "Item 2" }));
        ...
        jLabel5.setText("Seleccione Cta. Destino");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(29, 29, 29)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(Select, 0, 365, Short.MAX_VALUE)
                            .addComponent(Monto))))
                .addGap(39, 39, 39))
    ...
    cargarCuentasCliente();        // TODO add your handling code here:
    ...
    try {
        ...
        while (rs.next()) {
            ...
            Select1.addItem(numeroCuenta + " - " + idCuenta);
        }
